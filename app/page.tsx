        ...
        <section id="contact" className="mb-16 sm:mb-24 scroll-mt-24 reveal">
          ...
          <div className="border border-gray-800 rounded-lg p-6 sm:p-8 bg-gradient-to-br from-gray-900/50 to-transparent">
            ...
            <div className="space-y-4 mb-8">
              ...
              <div className="flex items-center gap-3 text-gray-300">
                <svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0zm.24 4.8c3.97 0 7.2 3.23 7.2 7.2s-3.23 7.2-7.2 7.2-7.2-3.23-7.2-7.2 3.23-7.2 7.2-7.2zm-4.32 7.2c0-2.39 1.93-4.32 4.32-4.32s4.32 1.93 4.32 4.32-1.93 4.32-4.32 4.32-4.32-1.93-4.32-4.32z"/>
                </svg>
                <a href="https://orcid.org/0009-0005-7198-9893" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition">
